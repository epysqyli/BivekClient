      ...
      <main className='relative'>
        ...
        {open ? (
          ...
          <Menu
            onClick={openSidebar}
            size={40}
            className='fixed bg-white bottom-10 right-5 p-2 rounded-full shadow-md shadow-slate-400 cursor-pointer transition-transform hover:scale-95 active:scale-90'
          />
        )}
      </main>
