...
const AdminLayout = ({ children }: ILayoutProps): ReactElement => {
  ...
  return (
    <OverlayProvider value={{ showOverlay, hideOverlay }}>
      ...
      <footer className='fixed bottom-0 w-full lg:w-2/5 xl:w-1/3 lg:fixed lg:left-1/2 lg:-translate-x-1/2 lg:bottom-10 lg:shadow lg:rounded-md lg:hover:shadow-md lg:opacity-50 lg:hover:opacity-100 bg-neutral-50 transition-opacity py-3 lg:py-5 lg:border-2 lg:border-amber-500'>
