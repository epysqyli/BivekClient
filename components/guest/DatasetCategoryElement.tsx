...
const DatasetCategoryElement = ({ datasetCategory }: Props): ReactElement => {
  return (
    <div className='my-10 pt-5 pb-10 px-2 mx-auto border-b border-slate-400 dark:border-none'>
      <h2 className="text-3xl tracking-tighter text-center mb-12 font-medium text-slate-700 dark:text-slate-100">{datasetCategory.name}</h2>
      <div>
