    ...
    <>
      {isDarkMode() ? (
        <div
          ...
          className='py-2 lg:py-5 mx-auto border-b-2 border-amber-400 cursor-pointer'
        >
        ...
        <div
          onClick={() => toggleDarkMode()}
          className='py-2 lg:py-5 mx-auto border-b-2 border-neutral-400 hover:border-neutral-200 group cursor-pointer'
        >
