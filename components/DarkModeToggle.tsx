    ...
    <>
      {isDarkMode() ? (
        <div
          ...
          className='py-5 mt-10 w-1/2 mx-auto border-b-2 border-amber-400 cursor-pointer'
        >
        ...
        <div
          onClick={() => toggleDarkMode()}
          className='py-5 mt-10 w-1/2 mx-auto border-b-2 border-neutral-400 hover:border-neutral-200 group cursor-pointer'
        >
